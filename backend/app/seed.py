...
DIRECTORS: list[tuple[str, int | None, str | None]] = [
    (
        "Christopher Nolan",
        1970,
        "British-American director known for cerebral, nonlinear storytelling.",
    ),
    (
        "Denis Villeneuve",
        1967,
        "French Canadian director acclaimed for visually striking science fiction.",
    ),
    ...
    (
        "Wes Anderson",
        1969,
        "American director known for symmetrical compositions and quirky style.",
    ),
...
MOVIES_DATA: list[tuple[str, int, int | None, list[str], list[int], str, int, list[int]]] = [
    (
        "Inception",
        2010,
        0,
